...
<body>
	<div class="divCur">
		...
		<br>
		<div id="botonheight">
			<button type="submit" onclick="location.href='consultarCursos.php'" class="btn btn-success">Guardar curso</button>
			<button type="submit" onclick="location.href='consultarCursos.php'" class="btn btn-danger">Cancelar</button>	
		</div>
	</div>
</body>
</html>